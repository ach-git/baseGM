...
function GM:trace(message)
    ...
    print(("^3[%s INFO]^7 %s^7"):format(GMConfig.gmName or "baseGM", message))
end
...
function GM:debug(message)
    ...
    print(("^3[%s DEBUG]^7 %s^7"):format(GMConfig.gmName or "baseGM", message))
end
...
function GM:formatEvent(eventName)
    return (("%s:%s"):format(GMConfig.gmName or "baseGM", GetHashKey(eventName)))
end